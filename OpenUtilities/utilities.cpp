...
namespace utilities {
	...
	void on_create(const game_object_script obj)
	{
		...
		else if (settings::fow::updatePos->get_bool() && obj->get_particle_target_attachment_object() && obj->get_particle_target_attachment_object()->is_valid() && obj->get_particle_attachment_object()->is_ai_base() && !obj->get_particle_target_attachment_object()->is_moving() && (!obj->get_particle_target_attachment_object()->get_path_controller() || obj->get_particle_target_attachment_object()->get_path_controller()->get_path_count() != 1) && !obj->get_particle_target_attachment_object()->is_visible() && !obj->get_particle_target_attachment_object()->is_hpbar_recently_rendered() && !obj->get_particle_target_attachment_object()->is_dead() && obj->get_particle_target_attachment_object()->get_position().is_valid())
		{
