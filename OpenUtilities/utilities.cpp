...
namespace utilities {
	...
	void on_create(const game_object_script obj)
	{
		...
		if (settings::fow::updatePos->get_bool() && obj->get_particle_attachment_object() && obj->get_particle_attachment_object()->is_valid() && !obj->get_particle_attachment_object()->is_moving() && !obj->get_particle_attachment_object()->get_no_render() && !obj->get_particle_attachment_object()->get_is_obscured() && !obj->get_particle_attachment_object()->is_visible() && !obj->get_particle_attachment_object()->is_hpbar_recently_rendered() && !obj->get_particle_attachment_object()->is_dead() && obj->get_particle_attachment_object()->get_position().is_valid() && obj->get_position().is_valid())
		{
		...
		else if (settings::fow::updatePos->get_bool() && obj->get_particle_target_attachment_object() && obj->get_particle_target_attachment_object()->is_valid() && !obj->get_particle_target_attachment_object()->is_moving() && !obj->get_particle_target_attachment_object()->get_no_render() && !obj->get_particle_target_attachment_object()->get_is_obscured() && !obj->get_particle_target_attachment_object()->is_visible() && !obj->get_particle_target_attachment_object()->is_hpbar_recently_rendered() && !obj->get_particle_target_attachment_object()->is_dead() && obj->get_particle_target_attachment_object()->get_position().is_valid())
		{
